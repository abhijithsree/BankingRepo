 ...
 * 
 * @Test public void testTransaction() throws URISyntaxException { final String
 * baseUrl =
 * "http://localhost:"+randomServerPort+"/financeTransaction/financeService";
 * URI uri = new URI(baseUrl); Map<String,Object> requestMap=new HashMap<String,
 * Object>(); requestMap.put("name","abhijith");
