package com.banking.balanceNotify.serviceImpl;
...
public class BankingNotificationServiceImple implements BankingNotificationService{
	...
	@Override
	public String sendNotificationToUser(String emailId,String password,String name,String accountNumber,double balance,String transaction,double amount) {
		...
		Properties props = new Properties();
		   ...
		   msg.setSubject("test");
		   msg.setContent("Hello "+name + "A Transaction of"+amount+"Rs"+""+transaction +" Happend"+" For Your Account Number: "+accountNumber+" and Your Balance Is:"+balance, "text/html");
