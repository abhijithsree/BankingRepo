 ...
 * 
 * import com.banking.authenticate.entities.LoginUser; import
 * com.banking.authenticate.repository.LoginRepository; import
 * com.banking.authenticate.serviceImpl.AuthServiceImpl;
 * 
 * 
 * 
 * 
 * @RunWith(SpringRunner.class) public class AuthUnitTest {
 * 
 * 
 * @Mock private LoginRepository bankRepo;
 * 
 * @Before public void setUp() { LoginUser account = new LoginUser();
 * 
 ...
 * 
 * 
 * //@Test public void testUser() { assertNotNull(authservice.createLogin(new
